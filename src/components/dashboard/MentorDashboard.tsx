    ...
    <div className="space-y-6">
      ...
      <div>
        ...
        <p className="text-gray-600 mt-2">
          Guide startups and share your expertise
        </p>
      </div>
            ...
            <Card>
              ...
              <CardContent>
                <div className="space-y-4">
                  ...
                  <div className="flex justify-between items-center">
                    <span className="text-sm">Pod Calls This Month</span>
                    <Badge variant="secondary">0</Badge>
                  </div>
                </div>
              </CardContent>
            ...
            <Card>
              ...
              <CardContent>
                <div className="text-center py-8 text-muted-foreground">
                  ...
                  <p className="text-sm">Start mentoring to see activity here</p>
                </div>
              </CardContent>
            </Card>
          </div>
        ...
        <TabsContent value="startups" className="mt-6">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Startups you're currently mentoring</CardDescription>
            </CardHeader>
            <CardContent>
              <div className="text-center py-8 text-muted-foreground">
                <Users className="h-12 w-12 mx-auto mb-4 opacity-50" />
                <p>No assigned startups</p>
                <p className="text-sm">Startup assignments will appear here</p>
              </div>
            </CardContent>
          </Card>
        </TabsContent>
        ...
        <TabsContent value="pod" className="mt-6">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Pod members and weekly calls</CardDescription>
            </CardHeader>
            <CardContent>
              <div className="text-center py-8 text-muted-foreground">
                <MessageSquare className="h-12 w-12 mx-auto mb-4 opacity-50" />
                <p>Pod functionality coming soon</p>
                <p className="text-sm">View your pod members and participate in weekly calls</p>
              </div>
            </CardContent>
          </Card>
        </TabsContent>
